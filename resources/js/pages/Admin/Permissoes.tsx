                                            ...
                                            permissoes.map((permissao) => (
                                                <tr key={permissao.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                                                    ...
                                                    <td className="px-6 py-4 text-sm">
                                                        <code className="px-2 py-1 bg-gray-100 dark:bg-gray-700 text-blue-600 dark:text-blue-400 rounded font-mono text-xs">
                                                            {permissao.nome}
                                                        </code>
                                                    </td>
                                    ...
                                    <div className="border-t dark:border-gray-700 pt-4">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 max-h-60 overflow-y-auto">
                                            {permissoesSugeridas.map((sugestao, index) => (
                                                ...
                                                >
                                                    <code className="text-xs text-blue-600 dark:text-blue-400 font-mono block">
                                                        {sugestao.nome}
                                                    </code>

...
export default function Forbidden({ message }: { message?: string }) {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-(--surface-main) text-(--text-strong)">
      ...
      <Link href="/dashboard" className="px-4 py-2 rounded-lg bg-(--brand-600) hover:bg-(--brand-700) text-white transition-colors">
        Voltar ao início
      </Link>
    </div>
  );
